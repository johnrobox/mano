...
<html lang="en">
    <head>
        ...
        <link href="<?php echo base_url();?>css/lib/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
        ...
        <script src="<?php echo base_url(); ?>js/accounting/login.js"></script>
    </head>
    <body>