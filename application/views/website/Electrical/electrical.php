						    ...
						    <div class="container">
						      <div class="row row-offcanvas row-offcanvas-left">
						        ...
						        <h2 style="">Categories</h2>
						            <ul class="nav">
						              <li class="active"><a href="http://localhost/mano/index.php/HomepageController/electrical">All</a></li>
						              <li><a href="#">Electrical Utilities</a></li>
						              <li><a href="#">Wiring Devices and Controls</a></li>
