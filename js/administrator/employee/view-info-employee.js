...
$(document).ready(function(){
    ...
    var viewEmployeeInfoButton = $(".viewEmployeeInfoButton");
    
    // modal
    var employeeViewInfoModal = $("#employeeViewInfoModal");
    
    var employee_id = 0;
    
    var employeeViewInfoLoadingImage = $("#employeeViewInfoLoadingImage");
